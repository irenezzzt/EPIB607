...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-5-1.png" alt="This empty plot has no geoms." width="576" />
<p class="caption">(\#fig:03-make-a-plot-5)This empty plot has no geoms.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-6-1.png" alt="A scatterplot of Life Expectancy vs GDP" width="576" />
<p class="caption">(\#fig:03-make-a-plot-6)A scatterplot of Life Expectancy vs GDP</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-7-1.png" alt="Life Expectancy vs GDP, using a smoother." width="576" />
<p class="caption">(\#fig:03-make-a-plot-7)Life Expectancy vs GDP, using a smoother.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-8-1.png" alt="Life Expectancy vs GDP, showing both points and a GAM smoother." width="576" />
<p class="caption">(\#fig:03-make-a-plot-8)Life Expectancy vs GDP, showing both points and a GAM smoother.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-9-1.png" alt="Life Expectancy vs GDP, points and an ill-advised linear fit." width="576" />
<p class="caption">(\#fig:03-make-a-plot-9)Life Expectancy vs GDP, points and an ill-advised linear fit.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-10-1.png" alt="Life Expectancy vs GDP scatterplot, with a GAM smoother and a log scale on the x-axis." width="576" />
<p class="caption">(\#fig:03-make-a-plot-10)Life Expectancy vs GDP scatterplot, with a GAM smoother and a log scale on the x-axis.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-11-1.png" alt="Life Expectancy vs GDP scatterplot, with a GAM smoother and a log scale on the x-axis, with better labels on the tick marks." width="576" />
<p class="caption">(\#fig:03-make-a-plot-11)Life Expectancy vs GDP scatterplot, with a GAM smoother and a log scale on the x-axis, with better labels on the tick marks.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-12-1.png" alt="What has gone wrong here?" width="576" />
<p class="caption">(\#fig:03-make-a-plot-12)What has gone wrong here?</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-13-1.png" alt="Setting the color attribute of the points directly." width="576" />
<p class="caption">(\#fig:03-make-a-plot-13)Setting the color attribute of the points directly.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-14-1.png" alt="Setting some other arguments." width="576" />
<p class="caption">(\#fig:03-make-a-plot-14)Setting some other arguments.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-15-1.png" alt="A more polished plot of Life Expectancy vs GDP." width="576" />
<p class="caption">(\#fig:03-make-a-plot-15)A more polished plot of Life Expectancy vs GDP.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-16-1.png" alt="Mapping the continent variable to the color aesthetic." width="624" />
<p class="caption">(\#fig:03-make-a-plot-16)Mapping the continent variable to the color aesthetic.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-17-1.png" alt="Mapping the continent variable to the color aesthetic, and correcting the error bars using the fill aesthetic." width="624" />
<p class="caption">(\#fig:03-make-a-plot-17)Mapping the continent variable to the color aesthetic, and correcting the error bars using the fill aesthetic.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-18-1.png" alt="Mapping aesthetics on a per-geom basis. Here color is mapped to continent for the points but not the smoother." width="624" />
<p class="caption">(\#fig:03-make-a-plot-18)Mapping aesthetics on a per-geom basis. Here color is mapped to continent for the points but not the smoother.</p>
</div>
...
<div class="figure">
<img src="05-ggplot_files/figure-html/03-make-a-plot-19-1.png" alt="Mapping a continuous variable to color." width="100%" />
<p class="caption">(\#fig:03-make-a-plot-19)Mapping a continuous variable to color.</p>
</div>
...
<div class="figure">
<img src="/Users/runner/work/EPIB607/EPIB607/inst/figures/ch-03-legends-combined.png" alt="Guides and legends faithfully reflect the mappings they represent." width="357" />
<p class="caption">(\#fig:legends-combined)Guides and legends faithfully reflect the mappings they represent.</p>
</div>
